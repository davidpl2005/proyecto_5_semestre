...
// Obtener inventario para mostrar stock
$inventarioModel = new Inventario();
$inventario_completo = $inventarioModel->getAll();

// Crear un array para acceso rápido al stock
$stock_productos = [];
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <span style="background-color: #f8d7da; color: #721c24; padding: 6px 12px; border-radius: 20px; font-size: 13px; font-weight: 700; display: inline-block;">
                                    ✗ AGOTADO
                                </span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if ($sin_stock): ?>
                                <!-- Si está agotado, mostrar estado de agotado independientemente de "disponible" -->
                                <span class="status-badge" 
                                      style="padding: 6px 12px; border-radius: 20px; font-size: 13px; font-weight: 600; display: inline-block; background-color: #f8d7da; color: #721c24;">
                                    ✗ Agotado
                                </span>
                            <?php else: ?>
                                <!-- Si hay stock, mostrar el estado normal -->
                        ...
                        <td>
                            ...
                            <?php if ($sin_stock): ?>
                                <a href="/Proyecto_aula/proyecto/controllers/InventarioController.php?action=registrar_entrada" 
                                   class="btn-ver-admin"
                                   style="background-color: #27ae60; display: block; margin-top: 5px; text-align: center;"
                                   title="Agregar stock">
                                    + Agregar Stock
                                </a>
                            <?php endif; ?>
